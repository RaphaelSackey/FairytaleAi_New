...
import Bbutton from "../buttons/basic";
	...
	return (
		<div className='section-wrapper grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 w-full h-fit lg:h-[80%] lg:min-h-[35rem] lg:max-h-[80%] lg:gap-3 mb-8'>
			<div className='content flex flex-col h-[35rem] min-h-[35rem] max-h-[35rem] lg:min-h-full lg:max-h-full lg:mr-40 lg:pt-14'>
				...
				<h3 className="font-suseMedium opacity-80 py-3">Discover the power of collaborative storytelling with Miro's AI Storyboard Generator. Get started today and see how it can help you create amazing stories!</h3>
				{true && <Bbutton>Button</Bbutton>}
			</div>
			...
			<div className='img relative h-[35rem] min-h-[35rem] lg:h-full max-h-full'>
				...
				<Image src={img} alt='img' fill={true} className="rounded-xl"/>
			</div>
		</div>
	);
}
